package com.optastack.common.util.rest.response;

import com.optastack.common.util.rest.response.builder.AbstractResponseBuilder;
import com.optastack.common.util.rest.response.builder.BodyBuilder;
import com.optastack.common.util.rest.response.builder.HeaderBuilder;
import com.optastack.common.util.rest.response.builder.StatusBuilder;
import java.net.URI;
